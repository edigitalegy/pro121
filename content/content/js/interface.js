...
const buttonsArray = [btnpretest,btnposttest,btnchatroom];
...
const elearray = [chat, act1,pretest,posttest];
...
btnposttest.addEventListener('click', () => {hiddenele(3);});
/************************************remove function******************************************/
...
/************************************************************************/
const pages = ["cont1.php", "cont2.php","cont3.php","cont4.php","cont5.php","cont6.php"];
